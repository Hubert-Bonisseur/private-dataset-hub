...
from dataset_hub.dataset_loader.utils import get_authentication_headers_for_url
from datasets import config, DownloadConfig
from datasets.filesystems import COMPRESSION_FILESYSTEMS
from datasets.utils.file_utils import is_local_path, is_remote_url, is_relative_path, url_or_path_join, http_head
...
class StreamingDownloadManager:
    ...
    def __init__(
        ...
        self._base_path = base_path or os.path.abspath("../../dataset_pusher")
